...
- [Simple SeqTree example](https://github.com/EulerLettersAI/seqtree/blob/main/examples/simple_seqtree.ipynb): the small
  documentation-style table with `age`, `sex_code`, `income_bin`, and
  `risk_code`.
- [Medical data with ifcfill](https://github.com/EulerLettersAI/seqtree/blob/main/examples/medical_ifcfill_seqtree.ipynb): loads a
